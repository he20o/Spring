...
import com.he20o.mapper.TestMapper;
import com.he20o.service.TestService;
...
//	public void getOnePlusTwo() {
	 ...
	 /* 문제 1*/
	  ...
	  @GetMapping("/updateVisitantCount") public void updateVisitantCount(){ log.
	  info("========================================== : 컨트롤러에서 updateVisitantCount() 실행중"
	...
	/* 문제 2 */
	  ...
	  @GetMapping("/insertDoodle") public void insertDoodle() {
	  
	  log.
	  info("========================================== : 컨트롤러에서 insertDoodle() 실행중"
	...
	/* 문제 3 */
	  ...
	  @GetMapping("/delTest") public void delTest() {
	  ...
	  @GetMapping("/main") public void cat() {
